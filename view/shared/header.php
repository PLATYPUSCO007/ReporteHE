		...
		<header id="header">
			...
			<nav id="nav">
				<ul>
                    <li><a href="reportar/index.view" class="menuItem" id="reportar" data-script="reporteHE">Reportar Horas Extra</a></li>
					<li><a href="estado/listEstado.view" class="menuItem" id="estado" data-script="listadoHE, detailsReporte">Mis Horas Extra</a></li>
                    <?php 
                    ...
                    ?>
					<li><a href="gestionHE/gestionar.view" class="menuItem" id="gestionar" data-script="aproveRejectHE, detailsReporte" data-aprobador="<?php echo $_SESSION['idAprobador']?>" data-rol="<?php echo $_SESSION['rol']?>" data-aprobadorCorreo="<?php echo $_SESSION['email']?>">Gestionar Horas Extra</a></li>
                    <?php 
                            }
                    ...
                    <li>
						...
						<ul>
                            ...
                            <li><a href="admin/clase.view" data-script="claseAdmin">Clase</a></li>
                            <!-- <li><a href="#" onclick="adminCECO(event)">Centros de Costo</a></li> -->
                            <li><a href="admin/centroCosto.view" data-script="cecoAdmin">Centros de Costo</a></li>
							<!-- <li><a href="#" onclick="adminAprobadores(event)">Aprobadores</a></li> -->
							<li><a href="admin/Aprobadores.view" data-script="aprobadoresAdmin">Aprobadores</a></li>
                    ...
                    <li><a href="gestionHE/gestionar.view" class="menuItem" id="gestionarRH" data-script="aproveRejectHE, detailsReporte" data-aprobadorCorreo="<?php echo $_SESSION['email']?>">Gestion RH</a></li>
                    ...
                    <li><a href="#" class="menuItem" id="mainContable">Gestion Contable</a>
                        <ul>
                            ...
                            <li><a href="gestionHE/gestionar.view" id="gestionarContable" data-script="aproveRejectHE, detailsReporte" data-aprobador="<?php echo $_SESSION['idAprobador']?>" data-aprobadorCorreo="<?php echo $_SESSION['email']?>">Aprobar/Rechazar</a></li>
                            <!-- <li><a href="#" id="reporte" onclick="reporte(event)">Generar Reporte</a></li> -->
                            <li><a href="reporte/index.view" id="reporte" data-script="">Generar Reporte</a></li>
                        </ul>
                    </li>
